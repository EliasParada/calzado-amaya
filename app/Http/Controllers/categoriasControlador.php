            ...
            switch ($request->ordenar) {
                case 'popular':
                    $query->select('productos.*')
                        ...
                        ->groupBy('productos.producto_id', 'productos.categoria_id', 'productos.nombre', 'productos.descripcion', 'productos.precio_venta', 'productos.imagenes', 'productos.codigo', 'productos.colores')
