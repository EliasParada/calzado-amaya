@if (!Auth::check())
    <div id="login-alert" class="alert fixed bottom-10 bg-gradient-to-tr from-main-orange to-main-yellow rounded-lg p-8 w-1/4 z-50">
    ...
    <div id="points-alert" class="alert fixed bottom-10 bg-gradient-to-tr from-main-orange to-main-yellow rounded-lg p-8 w-1/4 z-50">
        <div class="text-white">
    ...
    <div id="launch-day1-alert" class="alert fixed bottom-10 bg-gradient-to-tr from-main-orange to-main-yellow rounded-lg p-8 w-1/4 z-50">
        <div class="text-white">
    ...
    <div id="launch-day2-alert" class="alert fixed bottom-10 bg-gradient-to-tr from-main-orange to-main-yellow rounded-lg p-8 w-1/4 z-50">
        <div class="text-white">
