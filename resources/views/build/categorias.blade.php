                ...
                <a href="{{ route('producto', $producto->producto_id) }}" class="block h-full w-full flex flex-col gap-4 justify-between relative">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        @if ($producto->descuento)
                            <p><span class="text-base line-through text-gray-400">${{ $producto->precio_venta }}</span> <b class="text-xl text-yellow-500 font-bold">${{ number_format($producto->precio_venta - ($producto->descuento->descuento * $producto->precio_venta), 2) }}</b></p>
                        @else
