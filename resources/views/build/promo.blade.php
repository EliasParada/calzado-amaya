    ...
    <div class="bg-white p-4 shadow-md rounded-md relative">
        <a href="{{ route('producto', $promocion->productos->producto_id) }}" class="block h-full w-full flex flex-col gap-4 justify-between relative">
            ...
            <div class="flex flex-col gap-2">
                ...
                <p><span class="text-base line-through text-gray-200">${{ $promocion->productos->precio_venta }}</span> <b class="text-xl text-yellow-500 font-bold">${{ $promocion->productos->precio_venta - ($promocion->descuento * $promocion->productos->precio_venta) }}</b></p>
            </div>
